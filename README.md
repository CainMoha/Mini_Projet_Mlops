...
construction d'un baseline ML reproductible (scripts, config, artefacts),
versioning Git (commits propres, branches main/dev/feature),
collaboration GitHub via PR (template fourni),
tag/release d'une baseline (v0.1.0).
...
Déposez votre dataset dans data/dataset.csv
Modifiez config/train.yaml :
data:
  source: "csv"
